...
import magma from "../assets/magma.mp4";
import greenovavdo from "../assets/greenovavdo.mp4";
import ochivdo from "../assets/ochivdo.mp4";
import applevdo from "../assets/applevdo.mp4";
import lumine from "../assets/lumine.mp4";
import ecart from "../assets/ecart.mp4"
        ...
        <div className="cards flex gap-[5vw] mt-10 ">
          ...
          >
            ...
            >
              ...
              >
                <video src={greenovavdo} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
          ...
          >
            ...
            >
              ...
              >
                <video src={magma} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
        ...
        <div className="cards flex gap-[6vw] mt-10 ">
          ...
          >
            ...
            >
              ...
              >
                <video src={ochivdo} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
          ...
          <a
            onClick="window.open(this.href,'_blank');return false;"
            target="_blank"
            href="https://aryanmule.github.io/LUMINE/"
            className="w-1/2 h-[30vw]"
          >
            <div
              onMouseEnter={() => {
            ...
            >
              ...
              <motion.div
                ...
                className="card shadow-custom min-w-full min-h-full rounded-lg  overflow-hidden flex flex-col"
              >
                <video src={lumine} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
      ...
      <div className="px-[5.3vw] mt-[9vw]">
        <div className="cards flex gap-[6vw] mt-10 ">
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="card shadow-custom min-w-full min-h-full rounded-lg  overflow-hidden  border-[1px] border-zinc-700 flex flex-col"
              >
                <video src={ecart} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
          ...
          <a
            onClick="window.open(this.href,'_blank');return false;"
            target="_blank"
            href="https://aryanmule.github.io/AppleVisionReplica/"
            className="w-1/2 h-[30vw]"
          >
            <div
              onMouseEnter={() => {
            ...
            >
              ...
              <motion.div
                ...
                className="card shadow-custom min-w-full min-h-full rounded-lg  overflow-hidden flex flex-col"
              >
                <video src={applevdo} className="w-[100%] h-[28vw]" autoPlay loop muted></video>
